package com.hantsylabs.angularjs.ee7.sample.rest;
...
import com.hantsylabs.angularjs.ee7.sample.rest.dto.PostDTO;
...
public class PostEndpoint {
	@PersistenceContext(unitName = "angularjs-ee7-sample2-persistence-unit")
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Post> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT p FROM Post p WHERE p.id = :entityId ORDER BY p.id",
						Post.class);
	...
	@GET
	@Produces("application/json")
	public List<PostDTO> listAll(@QueryParam("start") Integer startPosition,
		...
		final List<Post> searchResults = findAllQuery.getResultList();
